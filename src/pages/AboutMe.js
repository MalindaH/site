    ...
    <>
        <div className='row my-intro'>
            ...
            <div className='col-9 mt-auto mb-auto'>
                <p>
                Hi there! My name is Linhui Huang and I also go by Malinda. I am a third- year (U2) student at McGill University, 
                studying Computer Science and Biology Joint Honours Program.<br />
                I have 3+ years of experience building programs, websites, and games, with proficient knowledge in computer 
